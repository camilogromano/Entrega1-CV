...
console.log("capturamos el evento click del botón usuario");
document.getElementById("subtitulo").innerHTML = "En la Ciudad de La PLata";
}

document.getElementById("titulo").onclick = function () {
console.log("capturamos el evento click del botón usuario");
document.getElementById("subtitulo").innerHTML = "Con experiencia en diferentes Niveles Educativos";
}
